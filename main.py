# -*- coding: utf-8 -*-
"""
Created on Mon Nov 20 17:26:16 2017
...
des_array=[]
training_data_array = []
matrix_images_clusters= np.array([])
...
def main(argv):
    ...
    for i in range(1,int(sys.argv[1]) + 1):
        extractor(directory = working_dir + '\Dataset\Nodo' + str(i) + '\\', nodo=i)
